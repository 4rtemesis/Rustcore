...
local PROFILE_SECTION_HEIGHT = 92
...
local function BuildOptionsFrame()
    ...
    f:SetSize(580, 618 + PROFILE_SECTION_HEIGHT)
    f:SetPoint("CENTER")
    ...
    local cbStats = MakeCheckbox(f,
        ...
        cbDurShowAll, -12, "showStatsWindow", -34)
    ...
    profileHeader:SetPoint("TOPLEFT", cbShowWarning, "BOTTOMLEFT", 0, -26)
    ...
    profileDesc:SetPoint("TOPLEFT", profileHeader, "BOTTOMLEFT", 0, -8)
    profileDesc:SetWidth(500)
    profileDesc:SetJustifyH("LEFT")
    profileDesc:SetText("Import window size/placement and durability HUD placement from another character.")
    ...
    importDropdown:SetPoint("TOPLEFT", profileDesc, "BOTTOMLEFT", -16, -8)
    UIDropDownMenu_SetWidth(importDropdown, 200)

    local importBtn = CreateFrame("Button", nil, f, "UIPanelButtonTemplate")
    importBtn:SetSize(120, 32)
    importBtn:SetPoint("LEFT", importDropdown, "RIGHT", 4, 2)
    importBtn:SetText("Import")
    RustcoreTheme.SkinButton(importBtn)
    ApplyBodyFont(importBtn:GetFontString(), 17)
    ...
    local function RefreshImportDropdownText()
        ...
        if selectedProfileKey and profiles[selectedProfileKey] then
            ...
            UIDropDownMenu_SetText(importDropdown, "Select character")
        end
    end
